      ...
      <div className="flex flex-wrap items-center gap-3">
        ...
        <div className="flex flex-col gap-1">
          ...
          <select
            ...
            className="bg-slate-50 border border-slate-200 rounded-xl px-3 py-1.5 text-xs font-semibold text-slate-700 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 max-w-[160px] transition-all cursor-pointer"
          >
